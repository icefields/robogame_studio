...
/**
 * This screen is almost identical to the SplashLoadingScreen, except we load many more assets. As long as it takes to load these assets,
 * our game will call the paint() method, in which we draw the splash screen image we loaded in the previous screen.
 */

/**
 * Once loading is complete, the MainMenuScreen opens. Notice that 
 * the previous two screens had empty backButton() methods. Since 
 * we do not want users pressing the backButton() in the middle of 
 * loading, we have intentionally left it blank.
 *
 */
...
public class LoadingScreen extends Screen {
    ...
    public void update(float deltaTime) {
        ...
        //This is how you would load a sound
        Assets.click = game.getAudio().createSound("SmallExplosion8-Bit.ogg");
        Assets.enemyDeath = game.getAudio().createSound("EnemyDeath.ogg");
